  ...
  return (
    ...
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center">
      ...
      <div>
          ...
          <div>
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div className="-m-2 rounded-xl bg-green-900/5 p-2 ring-1 ring-inset ring-green-950/10 lg:-m-4 lg:rounded-2xl lg:p-4">
        ...
        <ol className="mx-auto max-w-5xl sm:mt-56 my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
